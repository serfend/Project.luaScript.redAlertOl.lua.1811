...
function UI_TrackBar:Init(context,viewData,id,color)
	
end
--@summary:控件点击事件
--@param Action<string,string> callBack:控件被点击后的回调
function UI_TrackBar:OnClick(callBack)
...
function UI_TrackBar:Refresh()
	
	return false
end
--@summary:从布局中删除此控件
function UI_TrackBar:Delete()
